...
- **Consumer / test harness** for upstream [`elsapassaro/ramendr-starter-kit`](https://github.com/elsapassaro/ramendr-starter-kit), pinned by default to commit **`d6c21253595ea809c779279e20bcc3e990420781`** (fork branch **`ocp-4.22-rhdr-ramen`**). Hub Argo CD also tracks **`ocp-4.22-rhdr-ramen`** on the same fork.
...
2. Checks out `**UPSTREAM_REF`** (default `d6c21253595ea809c779279e20bcc3e990420781` from fork `ocp-4.22-rhdr-ramen`). Override: `UPSTREAM_REPO`, `UPSTREAM_REF`, `UPSTREAM_BRANCH`, `WORK_DIR`, `UPSTREAM_DIR`.
