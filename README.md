...
1. Clone the fork `elsapassaro/ramendr-starter-kit` at the pinned commit SHA `d6c21253595ea809c779279e20bcc3e990420781` (tip of fork branch `ocp-4.22-rhdr-ramen`) into `.work/upstream/ramendr-starter-kit`.
